...
\begin{Satz}
	...
	\begin{proof}
		...
		$ res_{UW}(s)=res_{VW}(t) $-
		Definiere nun $ E(\mathcal{F}) \coloneqq \bigcup_{x\in X} \mathcal{F}_x$. Dieser Raum muss nun noch mit einer
		Topologie ausgestattet werden.
	\end{proof}
\end{Satz}
...
%  \begin{tikzcd}
%    R_p \arrow[r , hookrightarrow ] & Q(R)
%  \end{tikzcd}
